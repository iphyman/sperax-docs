 ...
 function UnreleasedVersionLabel({ siteTitle, versionLabel }) {
   return (
     <Translate
       ...
       description="Label to warn user browsing unreleased version of the documentation"
       values={{
         siteTitle,
         versionLabel: <strong>{versionLabel}</strong>,
       }}>
       {
         'You are browsing an unreleased version of Sperax USDs documentation.' 
       }
     </Translate>
   );
 }
 ...
 function UnmaintainedVersionLabel({siteTitle, versionLabel}) {
   return (
     <Translate
       ...
       description="Label to warn user browsing old version of the documentation"
       values={{
         siteTitle,
         versionLabel: <strong>{versionLabel}</strong>,
       }}>
       {
         'This is documentation for {siteTitle} {versionLabel}, a previously released version of the {siteTitle}.'
       }
     </Translate>
   ); 
 }
